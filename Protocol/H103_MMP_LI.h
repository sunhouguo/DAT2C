...
{
public:
	CH103_MMP_LI(boost::asio::io_service & io_service);
	virtual ~CH103_MMP_LI(void);
...
private:
	...
	int AssembleCallAllData(size_t bufIndex, unsigned char * buf, share_terminal_ptr terminalPtr,unsigned char conCode = 0x01);
