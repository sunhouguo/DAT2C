...
{
public:
	CS101_B(boost::asio::io_service & io_service);
	~CS101_B(void);
...
private:
	...
	void handle_timerCirCle(const boost::system::error_code& error,share_commpoint_ptr point);
	...
	void ResetTimerCirCle(share_commpoint_ptr point,size_t yk_no,bool bContinue = false,unsigned short val = 0);
	...
	int AssembleRequireLink(size_t bufIndex, unsigned char * buf, share_pristation_ptr pristationPtr);
	int AssembleResetLink(size_t bufIndex, unsigned char * buf, share_pristation_ptr pristationPtr);
	int AssembleDoubleYKSelCon(size_t bufIndex, unsigned char * buf, share_pristation_ptr pristationPtr,unsigned short yk_no, unsigned char yk_code);
	int AssembleDoubleYKExeCon(size_t bufIndex, unsigned char * buf, share_pristation_ptr pristationPtr,unsigned short yk_no, unsigned char yk_code);
	int AssembleDoubleYKCancelCon(size_t bufIndex, unsigned char * buf, share_pristation_ptr pristationPtr,unsigned short yk_no,unsigned char yk_code);
	...
	int AssembleSingleYKCancelCon(size_t bufIndex, unsigned char * buf, share_pristation_ptr pristationPtr,unsigned short yk_no,unsigned char yk_code);
	...
	int AssembleTestCmdCon(size_t bufIndex,unsigned char * buf,share_pristation_ptr pristationPtr,unsigned short FBP);
	...
	int ParseLongFrame(unsigned char * buf, share_pristation_ptr pristationPtr);
	...
	int ParseTestCMD(unsigned char * buf,share_pristation_ptr pristationPtr);
	...
	unsigned char getSendFCB(share_pristation_ptr pristationPtr);
	int setSendFCB(share_pristation_ptr pristationPtr,unsigned char val);
...
private:
	enum S101_BPara
	{
		...
		DEFAULT_timeOutCirCle = 60
	};

	static size_t S101_BObjectCounter_;
	...
	unsigned short timeOutCirCle_;
	timerPtr timerCirCle_;
};
